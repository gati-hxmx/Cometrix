...
<template>
  <DefaultLayout>
    <!-- Hero セクション -->
<section
  class="bg-cover bg-center bg-no-repeat py-32 text-center"
  style="background-image: url('/hero-bg.png');"
>
  <div class="px-6">
    <!-- テキスト背景ボックス -->
    <div class="bg-black/30 backdrop-blur-sm rounded-lg p-8 text-white shadow-md">
      <h1 class="text-4xl font-bold mb-4">
        YouTubeライブチャットを<br class="sm:hidden" />可視化・分析する
      </h1>
      ...
      <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="grid sm:grid-cols-2 gap-6">
          ...
          <div class="bg-white border border-blue-500 rounded-lg p-6 shadow-md">
            <h3 class="text-xl font-bold mb-2 text-blue-600">Pro Plan</h3>
            <p class="text-sm text-gray-500 mb-4">¥980 / 月</p>
